...
concrete BrowseBen of Browse = CatBen, NumeralBen, LexiconBen, StructuralBen ** open LangBen in {

lincat ListAdv = LangBen.ListAdv ;
lincat ListAP = LangBen.ListAP ;
lincat ListNP = LangBen.ListNP ;
lincat ListRS = LangBen.ListRS ;
lincat ListS = LangBen.ListS ;
