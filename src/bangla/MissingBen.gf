...
oper AdjLN : AP -> LN -> LN  = notYet "AdjLN" ;
...
oper FemaleSurname : SN -> NP  = notYet "FemaleSurname" ;
oper FullName : GN -> SN -> NP  = notYet "FullName" ;
oper FunRP : Prep -> NP -> RP -> RP  = notYet "FunRP" ;
oper GenericCl : VP -> Cl  = notYet "GenericCl" ;
oper GivenName : GN -> NP  = notYet "GivenName" ;
oper IFrac : Decimal -> Dig -> Decimal  = notYet "IFrac" ;
...
oper InLN : LN -> Adv  = notYet "InLN" ;
oper MaleSurname : SN -> NP  = notYet "MaleSurname" ;
oper NegDecimal : Digits -> Decimal  = notYet "NegDecimal" ;
oper NumCard : Card -> Num  = notYet "NumCard" ;
oper NumDecimal : Decimal -> Card  = notYet "NumDecimal" ;
...
oper PlSurname : SN -> NP  = notYet "PlSurname" ;
oper PlainLN : LN -> NP  = notYet "PlainLN" ;
oper PosDecimal : Digits -> Decimal  = notYet "PosDecimal" ;
...
oper QuantityNP : Decimal -> MU -> NP  = notYet "QuantityNP" ;
