concrete ConstructionBen of Construction = CatBen ** open ParadigmsBen in {
...
lin
  ...
  in  SyntaxBen.mkAdv for_Prep n_hours_NP | mkAdv (n_hours_NP.s ! R.npNom) ;
  ...
  dayMonthAdv d m  =  ; -- on 17 Ben
  monthYearAdv m y =  ; -- in Ben 2012
  dayMonthYearAdv d m y =  ; -- on 17 Ben 2013
